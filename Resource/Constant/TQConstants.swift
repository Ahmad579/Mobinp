...
let BASE_URL  =  "http://mobinp.com/api/v1/"
...
let GETNOTARY_LUANGUAGE = BASE_URL + "notary/languages"
...
let ADDCARDINFO = BASE_URL + "client/payment-cards"
let COMPLETEJOB = BASE_URL + "client/request/complete"
let CLIENTPAYTONOTARY = BASE_URL + "client/payments"
let CLIENTREVIEWNOTARY = BASE_URL + "notary/reviews"
let NotaryReport = BASE_URL + "notary/reports"
...
let ADDLUANGUAGE = BASE_URL + "notary/languages"
let CONTACTUS = BASE_URL + "user/contact-us"
...
let PAYMENTCARD = BASE_URL + "client/payment-cards"

//"http://mobinp.com/api/v1/"
...
let kPasswordRequiredLength: Int = 1
